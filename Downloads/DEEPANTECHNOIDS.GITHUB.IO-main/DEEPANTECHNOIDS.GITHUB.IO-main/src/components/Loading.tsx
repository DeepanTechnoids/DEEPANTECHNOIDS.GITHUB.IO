    ...
    >
      ...
      <div className="relative z-10 text-center max-w-xs xs:max-w-sm sm:max-w-md lg:max-w-lg mx-auto px-4 xs:px-6">
        ...
        <div className="group w-16 h-16 xs:w-20 xs:h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 mx-auto mb-4 xs:mb-6 sm:mb-8 rounded-full overflow-hidden relative shadow-2xl">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-cyan-300 via-purple-300 via-pink-300 via-blue-300 via-green-300 via-yellow-300 to-cyan-300 rounded-full opacity-100 blur-sm animate-pulse"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-cyan-300 via-purple-300 via-pink-300 via-blue-300 via-green-300 via-yellow-300 to-cyan-300 rounded-full opacity-100 p-0.5">
          ...
          <div className="relative w-full h-full rounded-full overflow-hidden">
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML = '<div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-cyan-300 to-purple-400 text-white font-bold text-lg xs:text-xl sm:text-2xl lg:text-3xl">D</div>';
                }
              }}
            />
